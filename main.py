"""
Mahyar Nemati Apply to Linkedin Jobs using Python programming language.
In order to use this code please update the config file in order to access your linkedin account.
